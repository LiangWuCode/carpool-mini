<template>
  <tm-app ref="app" color="white">
    ...
    <tm-sheet :margin="[60, 0]">
      <tm-divider color="grey-darken-3" fontColor="black" align="center" label="请选择您需要发布的栏目"></tm-divider>
    </tm-sheet>
    <tm-divider :border="0.5" color="grey-1"></tm-divider>
    <tm-sheet :margin="[12, 0]" :padding="[0, 0]">
      <tm-row :column="12" :height="0">
        <tm-col align="center" @click="goToPublishDetail(1)" :height="0" color="primary" :round="3"
          :margin="[0, 0, 10, 0]" :col="6">
          <view class="flex flex-row-center-between px-10 py-30 fulled">
            <view class="ml-20">
              <tm-text _class="text-weight-b" :fontSize="32" label="我是车主"></tm-text>
              <tm-text _class="border-1 round-10 pa-3 px-10 mt-20" :fontSize="20" label="回家的路上不再孤单"></tm-text>
            </view>
        ...
        <tm-col :height="0" color="orange" :round="3" :margin="[10, 0, 0, 0]" align="center" :col="6"
          @click="goToPublishDetail(2)">
          <view class="flex flex-row-center-between px-10 py-30 fulled">
            <view class="ml-10">
              <tm-text _class="text-weight-b" :fontSize="32" label="我是乘客"></tm-text>
              <tm-text _class="border-1 round-10 pa-3 px-10 mt-20" :fontSize="20" label="节能环保，绿色出行"></tm-text>
            </view>
            <view class="white rounded pa-10 mr-20">
